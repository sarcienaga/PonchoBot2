...
if(counter === 10) {clearInterval(z);score=score+scoreInc;
godraw=true;$("#obj01").attr("fill","#ff0000");$("#obj02").css("opacity",0.9);showMessage("Ok");$("#buttonOk").remove();}}, 200);}
...
godraw=true;posX=pos0X;posY=pos0Y;dire=dire0;attempts++;score=score-scoreDec;if (tiAttempts) {if (attempts > attemptsMax) {showMessage("Attempts");} else {showMessage("Error");}} else {showMessage("Error");}
